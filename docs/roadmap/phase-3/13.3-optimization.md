...
[Phase 2](../phase-2/13.2-optimization.md) (GPU profiling, job system).*
...
from [Phase 1](../phase-1/13.1-optimization.md)'s `TimingProfiler` on an actual
game's content, not a synthetic benchmark. ECS cache optimization specifically is
[03-ECS Phase 2](../phase-2/03.2-entity-component-system.md)'s archetype/chunked
...
- [ ] If `TimingProfiler`/GPU profiling data shows ECS storage is the bottleneck,
      trigger [03-ECS Phase 2](../phase-2/03.2-entity-component-system.md)'s
      archetype storage
- [ ] Streaming optimizations, once
      [06-Scene Management Phase 3](06.3-scene-management.md)'s world
