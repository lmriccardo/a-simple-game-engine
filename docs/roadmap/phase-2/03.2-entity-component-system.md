...
[Phase 1](../phase-1/03.1-entity-component-system.md) (done: entities, components, queries).*
...
- **Archetypes/chunked storage** is a data-layout optimization over Phase 1's
  ...
  [13-Optimization](13.2-optimization.md) profiling actually shows Phase 1's storage is
...
- [ ] Archetype/chunked storage, gated on profiling evidence from
      [13-Optimization](13.2-optimization.md)
- [ ] Component read/write declarations per system (prerequisite for parallel execution)
- [ ] Parallel system execution, built on [01-Core Engine](../phase-1/01.1-core-engine.md)'s
      existing `ThreadPool`
...
[Phase 1](../phase-1/03.1-entity-component-system.md) is in real use and either
