...
[Phase 1](../phase-1/09.1-ui-framework.md) (immediate-mode, debug overlays),
[Phase 3](../phase-3/09.3-ui-framework.md) (styling, UI editor).*
...
- **Retained-mode is a different structure, not an extension of Phase 1's
  ...
  ECS entities+components ([03-ECS](03.2-entity-component-system.md)) rather than a
...
- Only worth building once gameplay actually needs UI that outlives a single frame's
  call (a pause menu, an inventory) — [Phase 1](../phase-1/09.1-ui-framework.md)'s
...
CSS-like styling, a UI editor — see [Phase 3](../phase-3/09.3-ui-framework.md).
