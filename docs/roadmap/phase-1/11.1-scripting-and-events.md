...
Other phases: [Phase 2](../phase-2/11.2-scripting-and-events.md) (managed scripting,
runtime reload).*
...
[01-Core Engine](01.1-core-engine.md)'s `FileWatcher` for change notifications.
...
[03-ECS Phase 1](03.1-entity-component-system.md) stubs a `Script`
...
- **Native scripting means a `Script` component invoking a plain C++
  ...
  [03-ECS](03.1-entity-component-system.md) `Script` placeholder becomes a real
  callback hook, not a new language.
- **Managed scripting (Lua/C#/Python) is well past MVP** and stays entirely in
  [Phase 2](../phase-2/11.2-scripting-and-events.md) — it needs a real embedding +
...
[Phase 2](../phase-2/11.2-scripting-and-events.md). A reflection system — not needed
for native callbacks, and [06-Scene Management](06.1-scene-management.md) is the doc
