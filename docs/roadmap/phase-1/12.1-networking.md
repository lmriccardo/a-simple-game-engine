...
Other phases: [Phase 2](../phase-2/12.2-networking.md) (prediction/interpolation),
...
- [ ] Basic state replication for [03-ECS](03.1-entity-component-system.md) entities
...
Everything beyond LAN — see [Phase 2](../phase-2/12.2-networking.md) and
[Phase 3](../phase-3/12.3-networking.md). This whole system stays out of scope
