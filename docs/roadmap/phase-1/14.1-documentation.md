...
## Design notes
- **Same shape as [13-Optimization](13.1-optimization.md): continuous, not a
...
## Tasks
- [x] Pick and configure a docs-site generator that consumes existing doc comments
- [x] Publish the generated reference somewhere reachable (even just a build
      artifact/local output, to start)
- [x] Keep this roadmap's per-system docs current as each system's actual state
...
Beginner tutorials ([Phase 2](../phase-2/14.2-documentation.md)); a full engine
manual ([Phase 3](../phase-3/14.3-documentation.md)) — both need more finished
